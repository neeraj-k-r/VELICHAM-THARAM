...
public class TorchPlugin extends Plugin {
    ...
    public void start(PluginCall call) {
        ...
        doStart(communityId, apiKey, projectId);
        call.resolve();
    }
    ...
    private void permissionGranted(PluginCall call) {
        String communityId = pendingCall != null && pendingCall.getData() != null
                ...
                : "kakkanad";
        String apiKey = pendingCall != null && pendingCall.getData() != null
                ? pendingCall.getString("apiKey", "")
                : "";
        String projectId = pendingCall != null && pendingCall.getData() != null
                ? pendingCall.getString("projectId", "")
                : "";
        doStart(communityId, apiKey, projectId);
        if (pendingCall != null) {
            pendingCall.resolve();
    ...
    private void doStart(String communityId, String apiKey, String projectId) {
        ...
        intent.putExtra(TorchForegroundService.EXTRA_API_KEY, apiKey);
        intent.putExtra(TorchForegroundService.EXTRA_PROJECT_ID, projectId);
