...
if (!firebaseConfig.apiKey || !firebaseConfig.projectId || !firebaseConfig.appId) {
  console.error('Missing Firebase credentials. Copy .env.example to .env with your Firebase Web App values, or export the VITE_FIREBASE_* environment variables.');
  process.exit(1);
}
