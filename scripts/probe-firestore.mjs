...
if (!API_KEY || !PROJECT) {
  console.error('Missing Firebase credentials. Run with:');
  console.error('  FIREBASE_API_KEY=<api key> FIREBASE_PROJECT_ID=<project id> node scripts/probe-firestore.mjs');
  process.exit(1);
}
